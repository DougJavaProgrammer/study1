...
public class TelaTimeThread extends JDialog{ //necessário extender a classe JDialog
	...
	public TelaTimeThread() { //executa o que tiver dentro no momento de abertura ou execução
		...
		gridBagConstraints.gridwidth = 2; //iniciando largura do grid  com 2, siginifica que todos os componentes vao ocupar no maximo dois espaços
		...
		jPanel.add(descricaoHora, gridBagConstraints); //adicionado label descricaohora na variavel jPanel e indicando o gerenciador de posições 
